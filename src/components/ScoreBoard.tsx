  ...
  return (
    <div className="flex items-center gap-4 justify-center">
      <div className="flex flex-col items-center">
        <span className="text-3xl sm:text-5xl font-bold" style={{ color: '#ffd700', textShadow: '0 0 10px #ffd70088' }}>{myScore}</span>
        <span className="text-xs tracking-widest" style={{ color: '#888' }}>YOU</span>
      </div>
      <span className="text-xl sm:text-2xl" style={{ color: '#333' }}>—</span>
      <div className="flex flex-col items-center">
        <span className="text-3xl sm:text-5xl font-bold" style={{ color: '#aaaaaa' }}>{oppScore}</span>
